...
institute: "Hertie School, Master of Data Science for Public Policy" #"`r format(Sys.time(), '%d %B %Y')`"
output:
...
<div alight = "center", style="display: flex; align-items: center; justify-content: center;">
...
<br>
<div align="center">
<img src="images/density.png" width=600>
</div>
