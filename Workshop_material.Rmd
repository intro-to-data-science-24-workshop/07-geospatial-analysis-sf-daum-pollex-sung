...
This tutorial will (1.) provide the code for creating the Christmas market map as you saw in the presentation and (2.) lead you step-by-step - using the sf-package - to answer the question, in which Berlin district, most people have to "share" a Christmas market and where they should go instead. It will also show you the **closest Christmas markets from Hertie School**.
...
## 2. Enrichting the Berlin Christmas market map with population dencity and proximity to Hertie School.

If you were the major of Berlin, you might ask yourself where to open a new, shiny Christmas market. Your intuition would be that a new Christmas market makes sense in a district, where there are fewest markets in relation to population size because you assume that markets are most crowded.

What is your intuition? Which district has fewest markets in relation to population size?

Let's find out with the help of the sf package. At the bottom of the code, there are 3 tasks for you to 
...
Our map shows that the christmas market density per 1000 residents is lowest in Lichtenberg (where there are 0 markets, if we believe the data we found) and Neukölln. Additionally, we can see that both districts have no neighboring districts with a very high density. So as mayor of Berlin we might decide to open our new market in either Neukölln or Lichtenberg. 
